module.exports = {
  ...
  inputs: {
    ...
    hashedPassword: {
      ...
      whereToGet: {
        description: 'Look up the (one-way-encrypted) password hash stored for this user from your database.',
  ...
  fn: function(inputs, exits) {
    ...
    // Run `compare` to compare the plaintext and hashed (one-way encrypted) passwords
    // in constant time.
